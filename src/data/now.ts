...
export const nowItems: NowItem[] = [
  {
    ...
    icon: "sparkles",
    description:
      "At ARIS I do my own data pulls, prototypes and design passes. Outside work I keep building. Mafia in a weekend with Cursor, DEDUCTION to figure out how LLMs hold a character, ShowTrackr for tracking what I watch.",
    links: [
