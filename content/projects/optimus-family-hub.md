...
|--------|--------|-------------|
| Family group creation rate | 15% of active users | Monthly cohort tracking |
| Shared pot contributions | 3+ contributions/month | Transaction analytics |
| Feature retention (30-day) | 45% | Cohort retention curves |
| NPS for family features | 50+ | Quarterly survey |
